...
use components::{
    EguiContext, EguiInput, EguiOutput, EguiRenderOutput, EguiUserTextures, WindowSize,
};
pub use egui;

use crate::{
    components::{EguiClipboard, EguiManagedTextures, EguiMousePosition, EguiSettings},
...
use bevy::{
    ...
    log,
    prelude::{
        Added, Commands, Entity, IntoSystemConfigs, Query, Shader, SystemSet, With, Without,
    },
    render::{
