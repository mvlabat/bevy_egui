...
///
/// The actual resource is a [`HashMap<WindowId, EguiInput>`].
...
///
/// The actual resource is a [`HashMap<WindowId, EguiShapes>`].
...
///
/// The actual resource is a [`HashMap<WindowId, EguiOutput>`].
#[derive(Clone, Default)]
